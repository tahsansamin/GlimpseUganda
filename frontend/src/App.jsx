...
function App() {
  ...
  return (
    <div className="App" style={{ padding: '20px' ,width: '100%' , height: '100%' }}>
      <div className="fixed top-4 right-4 z-50 bg-white shadow-md rounded-lg p-2 flex gap-2">
        <Link to="/" className="px-4 py-2 hover:bg-gray-100 rounded transition-colors text-gray-800 font-medium no-underline">Map</Link>
        <Link to="/upload" className="px-4 py-2 hover:bg-gray-100 rounded transition-colors text-gray-800 font-medium no-underline">Upload Documents</Link>
      </div>
